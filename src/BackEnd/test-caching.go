...
// key := caching.GetKeyHash("https://en.wikipedia.org/wiki/Poland")
// caching.DeleteCache("https://en.wikipedia.org/wiki/Poland")

// list_url := scraper.ScrapWeb("https://en.wikipedia.org/wiki/Poland")
// caching.SetCacheUrl("https://en.wikipedia.org/wiki/Poland", list_url)
